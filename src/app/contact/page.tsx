...
function InfoCard({
  ...
  return (
    <div
      className="relative flex items-start gap-4 rounded-2xl p-5 transition-all duration-300"
      style={{
    ...
    >
      ...
      <div className="min-w-0">
        ...
        {lines.map((line, i) => (
          <div key={i}>
            {line.label && (
              <p className="text-[0.65rem] uppercase tracking-widest font-semibold mb-0.5" style={{ color: "var(--foreground-muted)" }}>
                {line.label}
              </p>
            )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-8 xl:gap-12 items-start">
          ...
          <div className="flex flex-col gap-5">
            ...
            <InfoCard
              ...
              icon={
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true" style={{ color: "#9455ff" }}>
            ...
            <InfoCard
              ...
              icon={
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true" style={{ color: "#34d399" }}>
            ...
            <InfoCard
              ...
              icon={
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true" style={{ color: "#fbbf24" }}>
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(124,31,255,0.07) 0%, rgba(10,10,10,0.6) 100%)",
            ...
            >
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--foreground-secondary)" }}>
                Check our{" "}
                <a href="/free-resources" className="font-medium underline underline-offset-2 transition-colors hover:text-[#b890ff]" style={{ color: "#9455ff" }}>
                  Free Resources
                </a>{" "}
